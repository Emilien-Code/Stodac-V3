...
const MentionsLegales = ()=>{
  ...
  <ul>
    <li> <p> gratuité de la diffusion </p></li>
    <li> <p> respect de l'intégrité des documents reproduits (aucune modification, ni altération d'aucune sorte) </p></li>
    <li> <p> mention obligatoire : "© AMC EST - http://stodac.fr - droits réservés". Cette mention pointera grâce à un lien hypertexte directement sur le contenu </p></li>
    <li> <p> insertion d'une icône représentant le site internet </p></li>
    <li> <p> Les organismes sous tutelle ainsi que les autres ministères sont dispensés de cette demande d'autorisation sous réserve d'insertion de la mention : "© AMC EST - http://stodac.fr - droits réservés". Cette mention pointera grâce à un lien hypertexte directement sur le contenu. </p></li>
  </ul>
      </article>
...
<ul>
  <li> <p> ne pas utiliser la technique du lien profond, c'est-à-dire que les pages du site stodac.fr ne doivent pas être imbriquées à l'intérieur des pages d'un autre site, mais visibles par l'ouverture d'une fenêtre indépendante </p> </li>
  <li> <p>  mentionner la source qui pointera grâce à un lien hypertexte directement sur le contenu visé </p> </li>
